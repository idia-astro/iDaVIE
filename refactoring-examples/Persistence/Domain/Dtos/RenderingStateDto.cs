...
/// Source: VolumeDataSetRenderer fields (lines 67–219) and MomentMapRenderer.
...
public class RenderingStateDto
{
    ...
    /// <summary>"Point" or "Bilinear" — replaces UnityEngine.FilterMode enum.</summary>
    ...
    /// <summary>VolumeDataSetRenderer line 199.</summary>
    ...
    /// <summary>Persisted only when OverrideRestFrequency == true.</summary>
...
/// <summary>Foveated rendering configuration (VolumeDataSetRenderer lines 81–87).</summary>
...
/// <summary>Mask rendering configuration (VolumeDataSetRenderer lines 73–77).</summary>
...
/// <summary>
/// Moment map rendering configuration (MomentMapRenderer lines 91–99).
/// User-configurable per session; included in V1.
/// </summary>
